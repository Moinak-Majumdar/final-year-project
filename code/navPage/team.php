            ...
            <div class="container px-5 py-24 mx-auto">
                <div class="flex items-center lg:w-1/2 mx-auto border-b pb-10 mb-10 border-gray-800 sm:flex-row flex-col">
                    ...
                    <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                        ...
                        <span class="mt-2 w-40 h-auto flex justify-between">
                            ...
                            <a href="#" target=""><ion-icon name="logo-instagram" class="instagram text-2xl cursor-pointer"></ion-icon></a>
                            <a href="#" target=""><ion-icon name="logo-twitter" class="twitter text-2xl cursor-pointer"></ion-icon></a>
                            <a href="https://api.whatsapp.com/send?phone=+917595867560&text=Hi" target="_moinak"><ion-icon name="logo-whatsapp" class="whatsapp text-2xl cursor-pointer"></ion-icon></a>
                        </span>
                    </div>
                </div>
                <div class="flex items-center lg:w-1/2 mx-auto border-b pb-10 mb-10 border-gray-800 sm:flex-row flex-col">
                ...
                <div class="flex items-center lg:w-1/2 mx-auto sm:flex-row flex-col">
                    ...
                    <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                        ...
                        <p class="leading-relaxed text-lg text-sky-400">1.Content Writer.</p>
                        <span class="mt-2 w-40 h-auto flex justify-between">
                            ...
                            <a href="#" target=""><ion-icon name="logo-instagram" class="instagram text-2xl cursor-pointer"></ion-icon></a>
                            <a href="#" target=""><ion-icon name="logo-twitter" class="twitter text-2xl cursor-pointer"></ion-icon></a>
                            <a href="https://api.whatsapp.com/send?phone=+917063545715&text=Hi" target="_moinak"><ion-icon name="logo-whatsapp" class="whatsapp text-2xl cursor-pointer"></ion-icon></a>
                        </span>
                    </div>
                </div>
            </div> -->
