...
<body class="bg-gray-300 h-full w-full flex justify-center items-center">
   <section class="h-auto w-auto flex justify-center items-center flex-col">

            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="POST" autocomplete="off">
                <div class="w-full text-center my-4">
                    <h1 class="text-3xl text-indigo-600 font-bold">Remove User</h1>
                </div>
                <div class="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 gap-8 p-8 mx-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name"
                            class="w-full focus:bg-transparent rounded-lg border border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-400 bg-gray-400 bg-opacity-10 text-base outline-none text-gray-800 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    ...
                    <div class="col-row-2">
                        ...
                        <textarea  name="resone"
                            class="w-full bg-gray-400 bg-opacity-40 rounded border border-gray-700 focus:border-rose-600 focus:bg-transparent focus:ring-2 focus:ring-rose-400 h-32 text-base outline-none text-stone-900 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
